...
log_path = os.path.join(LOG_PATH, MODEL_NAME + '_log.txt')
...
for i, (train_index, val_index) in enumerate(skf.split(X_train, y_train)):
    ...
    for j in range(runs_per_fold):
        ...
        model.fit(X_tr, y_tr, shuffle=False, batch_size=batch_size, epochs=epochs, verbose=False, callbacks=callbacks)
